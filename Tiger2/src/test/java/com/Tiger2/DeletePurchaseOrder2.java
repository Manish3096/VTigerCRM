...
public class DeletePurchaseOrder2 extends Baseclass {
	@Test
	public void toDeletePurchase2() throws EncryptedDocumentException, IOException, InvalidFormatException
	{
	    ...
	    d.switchTo().alert().dismiss();//Click on cancel button in the popup
	    ...
	    {
	        Reporter.log("Subject is not deleted "+Actualsub);
	    }
	    else{
