...
import com.Tig.pom.CreateInvoicePage;
import com.Tig.pom.InvoicePage;
import com.Tig.pom.VtigerHomePage;

public class CreateInvoice3 extends Baseclass{
	@Test
	public void toCreateInvoice1() throws EncryptedDocumentException, IOException, InvalidFormatException
	{
		...
		d.switchTo().alert().accept();
		Reporter.log("Switch control from parent to the Alert popup and Select ok button",true);
		Reporter.log("Qty cannot be empty Alert Popup should be displayed.");
