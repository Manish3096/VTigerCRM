...
public class FileLibrary {
	...
	{
		FileInputStream f = new FileInputStream("./src/test/resources/data/commondata.property");
	...
	{
		FileInputStream f = new FileInputStream("./src/test/resources/data/Vtiger_PIS_testscript.xlsx");
